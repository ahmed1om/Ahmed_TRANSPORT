// Admin page to draw routes on map and save to Firestore
// but is old and not used in the current app version. You can use it as a reference or starting point if you want to add route editing features later.
//good lock (ahmed ibrahem) 2024-06-20
